...
def generar_grafico_lineal(df, nombre_archivo):
    ...
    with xlsxwriter.Workbook(nombre_archivo) as workbook:
        ...
        for idx, columna in enumerate(columnas, start=1):
            # Filtrar las columnas con todos los valores iguales a 0
            ...
            resumen_chart = workbook.add_chart({"type": "line"})
...
# Generar gráficos lineales para Geoquímica, excluyendo elementos con todos sus valores en 0
generar_grafico_lineal(df_geoquimica, "Grafico_Lineal_Geoquimica.xlsx")

# Generar gráficos lineales para Mineralogía, sin filtrar valores 0
generar_grafico_lineal(df_mineralogia, "Grafico_Lineal_Mineralogia.xlsx")